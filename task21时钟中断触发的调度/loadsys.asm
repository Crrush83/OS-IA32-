...
loadgdt:
         ...
         ;创建#6描述符，
         ;32MB可执行段
         mov dword [bx+0x30],0x0000ffff ;2^13 = 10 0000 0000 0000 -1 = 0x1fff 2^14 = 100 0000 0000 0000 -1 = 3fff   
         mov dword [bx+0x34],0x00cf9a00 
...
;   并继续初始化PIC
    ...
    flush:
      ...
      ;.震惊了 竟然是一次把保护模式位置写错了。。。
         jmp dword 0x30:0x100000 ;描述符5 4号000，10 0，000
