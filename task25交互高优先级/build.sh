...
gcc  -Wall -m32 -g -c  -I ../include -I ../libc/include ../multitask.c -o multitask.bin
gcc  -Wall -m32 -g -c  -I ../include -I ../libc/include ../focus.c -o focus.bin
...
memman.bin layer.bin list.bin multitask.bin focus.bin stdio.bin -o sys.bin -T '../linkscript.ld'
#make img
